...
export default class TemporaryWAndELines extends Component {
  ...
  render() {
    return (
      <View style={styles.container}>
        <H3 style={styles.header}>{translations.get('temporary_w_and_e_lines').toTitleCase()}</H3>
        <View style={styles.row}></View>
        <View style={styles.wrapper}>
          {this.props.temporaryWAndELines.map(item => {
            return (
